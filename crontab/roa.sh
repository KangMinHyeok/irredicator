...
python3.8 /home/mhkang/rpki-irr/irredicator/dataset/put_dataset.py --local_dir /net/data/vrps/ziggy-vrps/ --hdfs_dir /user/mhkang/vrps/ziggy-vrps/ --suffix csv --logfile put_ziggy_vrp.log
...
python3.8 /home/mhkang/rpki-irr/irredicator/dataset/put_dataset.py --local_dir /net/data/vrps/daily-tsv/ --hdfs_dir /user/mhkang/vrps/daily-tsv/ --suffix tsv --logfile put_vrp_daily_tsv.log